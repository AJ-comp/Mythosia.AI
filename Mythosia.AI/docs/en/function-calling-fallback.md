...
[FC ON history in ChatBlock]
  ...
  Assistant: (empty content, metadata: function_call=get_weather)   ¡ç problem: empty content
  Function: "Seoul: 15¡ÆC, Clear"                                   ¡ç problem: invalid role
  Assistant: "The weather in Seoul is 15¡ÆC and clear."

[After fallback conversion for FC OFF]
  User: "What's the weather in Seoul?"
  Assistant: "[Called get_weather({"city":"Seoul"})]"                ¡ç filled with call info
  User: "[Function get_weather returned: Seoul: 15¡ÆC, Clear]"      ¡ç role changed to User
  Assistant: "The weather in Seoul is 15¡ÆC and clear."
```
...
internal IEnumerable<Message> GetLatestMessagesWithFunctionFallback()
{
    ...
    {
        // Assistant with empty content (function call) ¡æ fill with call description
        ...
        // Function role ¡æ change to User role, keep result as content
