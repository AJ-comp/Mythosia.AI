...
/// <summary>
/// IAsyncEnumerable 스트리밍, LINQ, 병렬, 에러처리, StreamOptions 테스트.
/// 원본: AIServiceTestBase.Streaming.cs
/// </summary>
[TestClass]
public abstract class StreamingTestModule : TestModuleBase
{
    ...
    public async Task StreamingIsRealTimeNotBatchedTest()
    {
        try
        {
            ...
            const string longPrompt = "Write a single cohesive article of at least 1000 tokens about the history of computers, including major eras, key inventions, notable people, and practical impact on daily life.";
