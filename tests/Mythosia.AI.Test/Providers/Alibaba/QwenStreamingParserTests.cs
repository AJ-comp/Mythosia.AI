...
[TestClass]
[TestCategory("Unit")]
public class QwenStreamingParserTests
{
    [TestMethod]
    public void ToolCallsDelta_ParsesEveryCallInProviderOrder()
    {
        var calls = new QwenStreamingProbe().ParseFunctionCalls(
            """
            {
              "choices": [
                {
    ...
    public async Task StreamingInterleavedCalls_ExecuteSequentiallyAndSerializeOneBatch()
    {
        ...
        var service = new QwenService("offline-test-key", new HttpClient(handler));
    ...
    private sealed class QwenStreamingProbe : QwenService
    {
        public QwenStreamingProbe()
