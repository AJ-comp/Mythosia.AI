...
<video class="playground-video" controls playsinline preload="metadata" poster="../assets/playground-demo.png" aria-label="Video hướng dẫn giao diện Mythosia.AI Playground">
  ...
  <track kind="subtitles" src="../assets/playground-demo.vi.vtt?v=3" srclang="vi" label="Tiếng Việt" default>
  <track kind="subtitles" src="../assets/playground-demo.th.vtt?v=3" srclang="th" label="ไทย">
  Trình duyệt của bạn không hỗ trợ video nhúng. <a href="../assets/playground-demo.mp4?v=3">Tải video hướng dẫn</a>.
</video>

[Tải video (MP4)](../assets/playground-demo.mp4?v=3) · [Đọc phụ đề](../assets/playground-demo.vi.vtt?v=3)
