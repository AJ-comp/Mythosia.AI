...
<video class="playground-video" controls playsinline preload="metadata" poster="../assets/playground-demo.png" aria-label="Огляд інтерфейсу Mythosia.AI Playground">
  ...
  <track kind="subtitles" src="../assets/playground-demo.uk.vtt?v=4" srclang="uk" label="Українська" default>
  ...
  Ваш браузер не підтримує вбудоване відео. <a href="../assets/playground-demo.mp4?v=4">Завантажити відео</a>.
</video>

[Завантажити відео (MP4)](../assets/playground-demo.mp4?v=4) · [Прочитати субтитри](../assets/playground-demo.uk.vtt?v=4)
