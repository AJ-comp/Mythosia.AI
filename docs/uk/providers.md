...
> Потрібні Mythosia.AI 8.1.0 / Abstractions 4.1.0. Мінімальні версії для наявних функцій Astra та типова модель сервісу не змінюються.
...
Opus 5.5 підходить для перевірки коду та дослідження документів із кількома раундами інструментів. API completion і Run залишаються тими самими, але прогрес типово приховано, а збереження міркувань потребує уваги до історії. Потрібні Mythosia.AI 8.1.0 / Abstractions 4.1.0.
...
Щоб після швидкої чернетки ретельно перевірити код або документи, виберіть Grok 4.7 і налаштуйте рівень міркування для кожного запиту. Доступні наявні API відповіді, потокової передачі, Run, локальних інструментів, структурованого виводу та зображень. `grok-4.7` приймає текст і зображення, повертає текст; контекстне вікно — 500 000 токенів. Типовою моделлю залишається Grok 4.5. Потрібні Mythosia.AI 8.1.0 / Abstractions 4.1.0.
...
> Опубліковані пакети `Mythosia.AI` 8.0.0 / `Mythosia.AI.Abstractions` 4.0.0 вже містять базову підтримку Flash. `AIModels.DeepSeek.V4Pro`, `UseResponsesApi`, Files API, `DeepSeekImageFileContent`: Потрібні Mythosia.AI 8.1.0 / Abstractions 4.1.0. [v8.1.0](../../src/core/Mythosia.AI/RELEASE_NOTES.md#v810).
