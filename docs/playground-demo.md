...
<video class="playground-video" controls playsinline preload="metadata" poster="assets/playground-demo.png" aria-label="Mythosia.AI Playground interface walkthrough">
  ...
  <track kind="subtitles" src="assets/playground-demo.vtt?v=3" srclang="en" label="English" default>
  ...
  Your browser does not support embedded video. <a href="assets/playground-demo.mp4?v=3">Download the walkthrough</a>.
</video>

[Download the video (MP4)](assets/playground-demo.mp4?v=3) · [Read the captions](assets/playground-demo.vtt?v=3)
