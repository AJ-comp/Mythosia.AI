...
Três rounds no total, e `Completion.Usage` soma os três. Um medidor de contexto na UI deve usar `RoundUsage.TotalTokens` do último round — neste exemplo, o do round 3.
