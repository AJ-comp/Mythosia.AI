...
> 📍 **Pipeline de Pregunta y Respuesta:** [Reescritura de Consulta](rag-query-rewriting.md) → [Filtrado](rag-filtering.md) → [Embedding (si hace falta)](rag-embedding.md) → [Recuperación](rag-hybrid-search.md) → [Re-ranking](rag-reranking.md) → **`Construcción de Contexto`**
