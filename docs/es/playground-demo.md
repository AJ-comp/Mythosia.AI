...
<video class="playground-video" controls playsinline preload="metadata" poster="../assets/playground-demo.png" aria-label="Recorrido por la interfaz del Playground de Mythosia.AI">
  ...
  <track kind="subtitles" src="../assets/playground-demo.es.vtt?v=4" srclang="es" label="Español" default>
  ...
  Su navegador no admite vídeos integrados. <a href="../assets/playground-demo.mp4?v=4">Descargar el recorrido</a>.
</video>

[Descargar el vídeo (MP4)](../assets/playground-demo.mp4?v=4) · [Leer los subtítulos](../assets/playground-demo.es.vtt?v=4)
