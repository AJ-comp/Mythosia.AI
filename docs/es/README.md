...
<details>
<summary>Detalles de dependencias de paquetes</summary>
...
Elija búsqueda léxica, semántica o híbrida sin imponer embeddings a cada consulta. [Guía de búsqueda](rag-hybrid-search.md).
...
> Claude Opus 5.5 requiere compilaciones compatibles aún no publicadas de Core y Abstractions; consulta [configuración y migración](providers.md#claude-opus-55).
...
| **xAI** | `Mythosia.AI` | Grok 4.7, Grok 4.6, Grok 4.5 (predeterminado), Grok 4.3, Grok 4.20 (reasoning / non-reasoning), Grok Build |
...
Para elegir tamaños válidos al generar o editar imágenes, consulta las [opciones de imagen de Google por modelo](providers.md#google-image-options). Flash admite 512/1K/2K/4K, Flash-Lite actualmente 1K y Pro 1K/2K/4K. Flash/Lite ofrecen 14 relaciones de aspecto y Pro las 10 estándar; todos aceptan `Auto`. Los tamaños o relaciones explícitos no compatibles se rechazan antes de enviar la petición HTTP.
...
Reutiliza una imagen subida en varias preguntas a Flash con `DeepSeekImageFileContent`, mediante Chat Completions o Responses; V4 Pro, que solo admite texto, rechaza imágenes. Las incorporaciones V4 Pro, Responses y Files requieren compilaciones compatibles aún no publicadas de Core y Abstractions y no están en las versiones publicadas 8.0.0 / 4.0.0. Consulta [subida, reutilización y límites de imágenes](providers.md#deepseek-deepseekservice).
