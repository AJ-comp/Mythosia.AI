...
```csharp
service.SystemPrompt = "Eres un asistente conciso. Responde en una sola oración.";
...
var message = MessageBuilder.User("Resume este texto: ...")
    .Build();
...
var message = MessageBuilder.User("¿Qué muestra este diagrama?")
