...
<video class="playground-video" controls playsinline preload="metadata" poster="../assets/playground-demo.png" aria-label="Mythosia.AI Playground の画面操作ガイド">
  ...
  <track kind="subtitles" src="../assets/playground-demo.ja.vtt?v=6" srclang="ja" label="日本語" default>
  ...
  このブラウザーは埋め込み動画に対応していません。<a href="../assets/playground-demo.mp4?v=6">操作ガイドをダウンロード</a>してください。
</video>

[動画をダウンロード (MP4)](../assets/playground-demo.mp4?v=6) · [字幕を読む](../assets/playground-demo.ja.vtt?v=6)
