...
```csharp
service.SystemPrompt = "Du bist ein prägnanter Assistent. Antworte in einem Satz.";
...
var message = MessageBuilder.User("Fasse diesen Text zusammen: ...")
    .Build();
...
var message = MessageBuilder.User("Was zeigt dieses Diagramm?")
