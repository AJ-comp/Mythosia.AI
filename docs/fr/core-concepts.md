...
Ton app ajoute à la conversation **le function_call émis par le modèle au round 1 avec le résultat de l'outil** puis appelle le modèle **une seconde fois**. Le modèle voit maintenant :
