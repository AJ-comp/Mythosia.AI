...
> Les contrôles de Fable 5.1 nécessitent `Mythosia.AI` 8.0.0 et `Mythosia.AI.Abstractions` 4.0.0 ou ultérieurs. Les API Run, raisonnement/recherche et GPT-6 existantes conservent leurs versions minimales 7.1.0 / 3.1.0.
