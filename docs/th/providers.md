...
> ต้องใช้ Mythosia.AI 8.1.0 / Abstractions 4.1.0 รุ่นขั้นต่ำของฟีเจอร์ Astra เดิมและโมเดลเริ่มต้นของบริการไม่เปลี่ยน
...
ใช้ Opus 5.5 เมื่อต้องตรวจโค้ดหรือค้นคว้าเอกสารโดยเรียกเครื่องมือหลายรอบ ยังคงใช้ API completion และ Run เดิม แต่ค่าเริ่มต้นซ่อนความคืบหน้า และต้องระวังการแก้ประวัติหากต้องการเก็บการให้เหตุผลไว้ ต้องใช้ Mythosia.AI 8.1.0 / Abstractions 4.1.0
...
เมื่อต้องการร่างคำตอบอย่างรวดเร็วแล้วตรวจโค้ดหรือเอกสารอย่างละเอียด ให้เลือก Grok 4.7 และปรับระดับการให้เหตุผลในแต่ละคำขอ ใช้ API เดิมสำหรับคำตอบ สตรีม Run เครื่องมือภายใน ผลลัพธ์แบบมีโครงสร้าง และภาพขาเข้าได้ `grok-4.7` รับข้อความและภาพ คืนข้อความ และมีบริบท 500,000 โทเคน ต้องใช้ Mythosia.AI 8.1.0 / Abstractions 4.1.0 โมเดลเริ่มต้นยังเป็น Grok 4.5
...
> Mythosia.AI 8.0.0 / Abstractions 4.0.0 รองรับ Flash พื้นฐาน `AIModels.DeepSeek.V4Pro`, `UseResponsesApi`, Files API, `DeepSeekImageFileContent`: ต้องใช้ Mythosia.AI 8.1.0 / Abstractions 4.1.0 [v8.1.0](../../src/core/Mythosia.AI/RELEASE_NOTES.md#v810).
