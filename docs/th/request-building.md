...
คำขอที่ผู้ใช้รอหน้าจออาจเหมาะกับการประมวลผลแบบเสียเงินที่มีความหน่วงต่ำ ส่วนรายงานเบื้องหลังใช้แบบปกติได้ `WithSpeed` เลือกโหมดโดยคงโมเดลและระดับการให้เหตุผลเดิม ต้องใช้ Mythosia.AI 8.1.0 / Abstractions 4.1.0
