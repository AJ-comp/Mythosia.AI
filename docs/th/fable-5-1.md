...
> การตั้งค่า Fable 5.1 ต้องใช้ `Mythosia.AI` 8.0.0 และ `Mythosia.AI.Abstractions` 4.0.0 ขึ้นไป ส่วน API Run การให้เหตุผล/ค้นหา และ GPT-6 เดิมยังใช้เวอร์ชันขั้นต่ำ 7.1.0 / 3.1.0
