...
export const ragPerplexityModelRow = $('#rag-perplexity-model-row');
export const ragPerplexityModel = $('#rag-perplexity-model');
export const ragPerplexityDimensions = $('#rag-perplexity-dimensions');
export const ragPerplexityKey = $('#rag-perplexity-key');
export const ragPerplexityKeyInput = $('#rag-perplexity-key-input');
export const ragPerplexityKeySave = $('#rag-perplexity-key-save');
export const ragPerplexityKeyStatus = $('#rag-perplexity-key-status');
