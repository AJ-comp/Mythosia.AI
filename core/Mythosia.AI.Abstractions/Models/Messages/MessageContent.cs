...
namespace Mythosia.AI.Models.Messages
{
    ...
    public class TextContent : MessageContent
    {
        ...
        public override object ToRequestFormat(string provider)
        {
            ...
            {
                nameof(AIProvider.OpenAI) => new { type = "text", text = Text },
                nameof(AIProvider.xAI) => new { type = "text", text = Text },
                nameof(AIProvider.Anthropic) => new { type = "text", text = Text },
                nameof(AIProvider.Google) => new { text = Text },
                _ => Text
            };
        }
    ...
    public class ImageContent : MessageContent
    {
        ...
        public override object ToRequestFormat(string provider)
        {
            ...
            return provider switch
            {
                ...
                nameof(AIProvider.Anthropic) => new
                {
                    type = "image",
                    source = new
                    {
